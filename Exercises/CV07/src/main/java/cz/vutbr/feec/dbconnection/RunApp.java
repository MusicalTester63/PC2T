...
public class RunApp {
  ...
  public static void main(String[] args) {
    ...
    while (run) {
      ...
      System.out.println("Vyberte požadovanou cinnost:");
      ...
      switch (choice) {
        case 1:
          // tento príklad znázor?uje vložení uživatele s emailem: myname123@stud.feec.vutbr.cz,
          // jménem Jon, prijmením Doe, vekem 30 let a výší platu 10 000
        ...
        case 3:
          ...
          // dopl?te tuto metodu dle zadání v metode
        ...
        case 4:
          ...
          int iD = ConsoleInput.readNumberInputFromConsole(sc);

          selectUserRoles.getAllUsersWithRoleUserById(iD);
          break;
        case 5:
          SelectQueries selectUser = new SelectQueries();
          System.out.println("Email a plat uživatele pred zvýšením platu o 20%");
          selectUser.printUserEmailAndSalary("myname@stud.feec.vutbr.cz");
          UpdateQueries updateQuery = new UpdateQueries();

          // dopl?te tuto metodu, tak abyste tomuto uživateli zvýšili plat o 20%
        ...
        case 6:
          System.out.println(
              "Zadejte email uživatele, kterého chcete vymazat z databáze (napr. myname123@stud.feec.vutbr.cz)");
          ...
          if (s.testIfUserExists(userName)) {
            ...
            System.out
                .println("Uživatel se zadaným emailem neexistuje, zkuste zadat email správne.");
            break;
          }
          break;
        case 7:
